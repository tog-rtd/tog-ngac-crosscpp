curl -G "http://127.0.0.1:8001/paapi/loadpol" --data-urlencode "policyfile=EXAMPLES/policy_signals_access.pl" --data-urlencode "token=admin_token"
curl -G "http://127.0.0.1:8001/paapi/getpol" --data-urlencode "token=admin_token"
curl -G "http://127.0.0.1:8001/paapi/loadpol" --data-urlencode "policyfile=EXAMPLES/policy_vehicle_ownership.pl" --data-urlencode "token=admin_token"
...
curl -G "http://127.0.0.1:8001/paapi/add" --data-urlencode "policy=Combined Policy" --data-urlencode "policy_element=assign('User 1',uattr1)" --data-urlencode "token=admin_token"
curl -G "http://127.0.0.1:8001/paapi/delete" --data-urlencode "policy=Combined Policy" --data-urlencode "policy_element=assign('User 1',uattr1)" --data-urlencode "token=admin_token"
echo 'try to add and delete user - should succeed'
curl -G "http://127.0.0.1:8001/paapi/add" --data-urlencode "policy=Policy (a)" --data-urlencode "policy_element=user(u3)" --data-urlencode "token=admin_token"
curl -G "http://127.0.0.1:8001/paapi/delete" --data-urlencode "policy=Policy (a)" --data-urlencode "policy_element=user(u3)" --data-urlencode "token=admin_token"
...
curl -G "http://127.0.0.1:8001/paapi/loadpol" --data-urlencode "policyfile=EXAMPLES/policy3a.pl" --data-urlencode "token=admin_token"
curl -G "http://127.0.0.1:8001/paapi/getpol" --data-urlencode "token=admin_token"
echo 'set to the newly loaded policy'
curl -G "http://127.0.0.1:8001/paapi/setpol" --data-urlencode "policy=Policy3" --data-urlencode "token=admin_token"
curl -G "http://127.0.0.1:8001/paapi/getpol" --data-urlencode "token=admin_token"
echo 'access checks, expect g d g g d'
curl -G "http://127.0.0.1:8001/pqapi/access" --data-urlencode "user=jones" --data-urlencode "ar=read" --data-urlencode "object=mrec1"
curl -G "http://127.0.0.1:8001/pqapi/access" --data-urlencode "user=jones" --data-urlencode "ar=write" --data-urlencode "object=mrec1"
curl -G "http://127.0.0.1:8001/pqapi/access" --data-urlencode "user=smith" --data-urlencode "ar=write" --data-urlencode "object=mrec1"
curl -G "http://127.0.0.1:8001/pqapi/access" --data-urlencode "user=smith" --data-urlencode "ar=read" --data-urlencode "object=mrec1"
curl -G "http://127.0.0.1:8001/pqapi/access" --data-urlencode "user=smith" --data-urlencode "ar=read" --data-urlencode "object=Medical Records"
echo 'unload the policy'
curl -G "http://127.0.0.1:8001/paapi/purgepol" --data-urlencode "policy=Policy3" --data-urlencode "token=admin_token"
