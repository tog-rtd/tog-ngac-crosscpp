...
echo 'run first four test cases for Policy (a) with conditions, expect grant grant grant deny'
curl -s -G "http://127.0.0.1:8001/pqapi/accessm" --data-urlencode "access_queries=[(u1,r,o1,true),(u1,w,o1),(u2,r,o2,true),(u1,w,o2)]"
...
echo 'run first four test cases for Policy (b) with conditions, expect deny deny grant grant'
curl -s -G "http://127.0.0.1:8001/pqapi/accessm" --data-urlencode "access_queries=[(u1,r,o1,true),(u1,w,o1),(u1,r,o2,true),(u1,w,o2)]"
